...
public class DateChooser extends JDialog
	...
	private static final String[] DAYS = new String[] { "Воскресенье", "Понедельник", "Вторник", "Среда", "Четверг",
			"Пятница", "Суббота" };
	private static final Color WEEK_DAYS_FOREGROUND = new Color(0, 0, 0);
	private static final Color DAYS_FOREGROUND = new Color(0, 0, 0);
	private static final Color SELECTED_DAY_FOREGROUND = new Color(63, 199, 127);
	private static final Color SELECTED_DAY_BACKGROUND = new Color(207, 207, 207);
	private static final Border EMPTY_BORDER = BorderFactory.createEmptyBorder(1, 1, 1, 1);
	private static final Border FOCUSED_BORDER = BorderFactory.createLineBorder(new Color(150, 160, 155), 1);
	private static final int FIRST_YEAR = 1997;
	...
	private void construct() {
		...
		daysGrid.setBackground(new Color(164, 203, 205));
